<!--publish=false-->
### 2.0.0:
- Fix Woodcutter Variants' crafting recipes sometimes being overwritten by the default Woodcutter recipe
- `1.21.4(-11)`:
